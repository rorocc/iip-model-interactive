...
<template>
  <div class="drop-shadow-xl ia-container px-12 py-6 rounded-lg border-gray-200 border">
    <div id="closeSubloopInputAdequacy" class="right-0 hover:cursor-pointer absolute bg-white p-2 m-1 top-0 rounded-full">
    ...
    <svg width="809" height="646" viewBox="0 0 809 646" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="iip-model-input-adequacy">
        ...
        <text id="Heading-Acquisition" fill="#DCC091" xml:space="preserve" style="white-space: pre" font-family="Inter" font-size="32" font-weight="bold" letter-spacing="0.05em"><tspan x="50" y="638.136">INPUT ADEQUACY</tspan></text>
        <g id="Frame 12">
