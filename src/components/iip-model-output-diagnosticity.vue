<script>
  export default{
    name: 'iip-model-output-diagnosticity',
    components: {},
    data() {
      return {}
    }
...
<template>
  <div class="drop-shadow-xl od-container px-12 py-6 rounded-lg border-gray-200 border">
    <div id="closeSubloopOutputDiagnosticity" class="right-0 hover:cursor-pointer absolute p-2 m-1 top-0 rounded-full bg-white">
    ...
    <svg width="809" height="646" viewBox="0 0 809 646" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        ...
        <clipPath id="clip1_57_145">
          <rect x="99" y="31" width="261" height="88" rx="8" fill="white"/>
        </clipPath>
        <clipPath id="clip2_57_145">
          <rect x="602" y="281" width="207" height="88" rx="8" fill="white"/>
        </clipPath>
      </defs>
    </svg>
